...
type AutomationRule = {
  id: string
  name: string
  triggerType: 'inactivity' | 'birthday' | 'anniversary' | 'purchase' | 'custom'
...
const mockAutomationRules: AutomationRule[] = [
  {
    ...
    status: 'active',
    message: 'Feliz aniversário, {nome}! Aproveite seu dia especial com 15% de desconto em sua próxima compa. Use o cupom: ANIVERSARIO15',
  ...
  },
  {
    ...
    status: 'active',
    message: 'Oi {nome}, sentimos sua falta! Volte para aproveitar nossas novidades e ofertas especiais.',
    daysAfter: 15,
    channels: ['email', 'sms'],
  ...
  },
  {
    ...
    status: 'inactive',
    message: 'Olá {nome}, obrigado por sua primeira compa! Esperamos que tenha uma ótima experiência com seu produto.',
    channels: ['email'],
  ...
  },
  {
    ...
    status: 'active',
    message: 'Parabéns {nome}! Faz 1 ano que você está conosco. Como agradecimento, aqui está um cupom de 10% de desconto: ANO1',
...
export default function CustomerExperienceAutomation() {
  ...
  const [formData, setFormData] = useState<Omit<AutomationRule, 'id' | 'createdAt' | 'lastEdited'>>({
    name: '',
    triggerType: 'inactivity',
    status: 'active',
    message: '',
    ...
    if (isEditing && currentRule) {
      setRules(rules.map(rule =>
        rule.id === currentRule.id
          ? { ...formData, id: currentRule.id, createdAt: currentRule.createdAt, lastEdited: now }
          : rule
      ))
    } else {
      setRules([
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-6">Automação de Experiência do Cliente</h1>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Configure mensagens automáticas para diferentes eventos do cliente
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
                  ...
                  <TableRow key={rule.id}>
                    ...
                    <TableCell>
                      <div className="flex items-center">
                        ...
                        {rule.daysAfter && (
                          <span className="ml-1">({rule.daysAfter} dias)</span>
                        )}
                      </div>
                    </TableCell>
                    <TableCell>
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              <DialogTitle>
                {isEditing ? 'Editar Regra de Automação' : 'Nova Regra de Automação'}
              </DialogTitle>
              <DialogDescription>
                {isEditing
