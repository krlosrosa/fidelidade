...
import { PlusIcon, UserIcon, QrCodeIcon, SearchIcon, ZapIcon } from "lucide-react";
...
export default function AdicionarPontosPage() {
    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-md mx-auto">
        ...
        <header className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-1">Adicionar Pontos</h1>
          <p className="text-gray-600">Registre pontos para seus clientes de forma rápida</p>
        </header>
            ...
            <div className="space-y-4 p-6">
              ...
              <div className="bg-blue-50 p-3 rounded-lg border border-blue-100">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Pontos a adicionar:</span>
                  <span className="text-lg font-bold text-blue-600">120 pts</span>
                </div>
              </div>
